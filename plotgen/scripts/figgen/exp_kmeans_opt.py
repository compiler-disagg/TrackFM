...
nam = "scripts/figgen/results/kmeans_results/carm/log."
for i in list1: 
    readFile(nam, i, cm1)
nam = "scripts/figgen/results/kmeans_results/carm_with_chunk/log."
for i in list1: 
    readFile(nam, i, cm2)
nam = "scripts/figgen/results/kmeans_results/carm_with_chunk_prof/log."
for i in list1: 
    readFile(nam, i, cm3)
j=0
