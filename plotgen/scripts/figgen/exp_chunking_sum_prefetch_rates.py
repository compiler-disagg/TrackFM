...
nam = "scripts/figgen/results/chunking_results_nov28/prefetch_rates/carm/sum/log."
for i in list1: 
    readFile(nam, i, cm)
nam = "scripts/figgen/results/chunking_results_nov28/prefetch_rates/carm/sum_no_prefetch/log."
for i in list1: 
