...
nam = "scripts/figgen/results/chunking_results_nov28/carm_guards/triad/log."
for i in list1: 
    readFile(nam, i, cm)
nam = "scripts/figgen/results/chunking_results_nov28/carm_guards/triad_no_chunk/log."
for i in list1: 
