...
nam = "scripts/figgen/results/loop_cost_results/carm/log."
readFile(nam, 5512, cm_x, cm_y, mem_filter)
nam = "scripts/figgen/results/loop_cost_results/carm_no_chunk/log."
readFile(nam, 5512, cm_no_chunk_x, cm_no_chunk_y, mem_filter)
j = 0
