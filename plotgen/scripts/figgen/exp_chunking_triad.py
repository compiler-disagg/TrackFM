...
nam = "scripts/figgen/results/chunking_results_nov28/carm_chunk_triad/log."
for i in list1: 
    readFile(nam, i, cm)
nam = "scripts/figgen/results/chunking_results_nov28/carm_triad_no_chunk/log."
for i in list1: 
...
#cm2d.set_y_limit(-5, 45)
#cm2d.set_y_lg_scale()
#cm2d.set_y_limit(1, 1.2)
