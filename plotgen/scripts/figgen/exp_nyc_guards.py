...
def readFile (fname, i, ls):
    ...
    flag = 0
    for x in f:
        if (x.count("CARM Runtime Calls") > 0):
            lp = x.split(":")
...
nam = "scripts/figgen/results/NYC_results_oct22/carm_with_profile_checks/log."
for i in list1: 
    readFile(nam, i, cm)
nam = "scripts/figgen/results/NYC_results_oct22/fastswap_results/log."
for i in list1: 
    readFile(nam, i, fs)
j=0
