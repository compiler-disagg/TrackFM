...
# sum
logs[0]['with']    = "scripts/figgen/results/chunking_results_nov28/carm_chunk_sum/log."
logs[0]['without'] = "scripts/figgen/results/chunking_results_nov28/carm_chunk_no_sum/log."

# copy
logs[1]['with']    = "scripts/figgen/results/chunking_results_nov28/carm_chunk_copy/log."
logs[1]['without'] = "scripts/figgen/results/chunking_results_nov28/carm_chunk_no_copy/log."

# triad
logs[2]['with']    = "scripts/figgen/results/chunking_results_nov28/carm_chunk_triad/log."
logs[2]['without'] = "scripts/figgen/results/chunking_results_nov28/carm_triad_no_chunk/log."
