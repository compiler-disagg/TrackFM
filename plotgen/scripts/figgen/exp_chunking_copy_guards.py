...
nam = "scripts/figgen/results/chunking_results_nov28/carm_guards/copy/log."
for i in list1: 
    readFile(nam, i, cm)
nam = "scripts/figgen/results/chunking_results_nov28/carm_guards/copy_no_chunk/log."
for i in list1: 
    readFile(nam, i, cm_no_chunk)
nam = "scripts/figgen/results/chunking_results_nov28/fastswap/copy/log."
for i in list1: 
    readFile(nam, i, fs)
