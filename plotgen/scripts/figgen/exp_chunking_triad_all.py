...
readFile(nam, 1, ln)
cpp_local_triad = ln[0]

for i in list1: 
    ln.append(float(cpp_local_triad))
nam = "scripts/figgen/results/chunking_results_nov28/carm_chunking_prefetch_enabled/carm_triad/log."
for i in list1: 
    readFile(nam, i, cm)
nam = "scripts/figgen/results/chunking_results_nov28/fastswap/triad/log."
for i in list1: 
    readFile(nam, i, fs)
nam = "scripts/figgen/results/chunking_results_nov28/aifm/triad/log."
for i in list1: 
    readFile(nam, i, am)
j=0
