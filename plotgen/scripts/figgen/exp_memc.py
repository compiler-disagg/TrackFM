...
nam = "scripts/figgen/results/memcached_results_nov24/linux_local/log"
readFile(nam, ln)
nam = "scripts/figgen/results/memcached_results_nov24/fastswap/log"
readFile(nam, fs)
nam = "scripts/figgen/results/memcached_results_nov24/carm/log"
readFile(nam, cm)
j=0
fsd = []
for i in list1:
