...
nam = "scripts/figgen/results/nas/nas_norm_carm/no_loop_opt/"
for i in list1: 
    readFile(nam, i, cm1)

nam = "scripts/figgen/results/nas/nas_norm_carm/loop/"
for i in list1: 
    readFile(nam, i, cm2)
# create plot
fig, ax = plt.subplots()
...
rects2 = ax.bar(index + bar_width, cm1, bar_width,
align='center',
alpha=opacity,
color='#0486db',
hatch='////',
label='TrackFM without loop opt',
edgecolor='black')

rects3 = ax.bar(index + bar_width + bar_width, cm2, bar_width,
align='center',
alpha=opacity,
color='#05acd3',
hatch='---',
label='TrackFM with loop opt',
edgecolor='black')
