...
logs[0]['without'] = "scripts/figgen/results/chunking_results_nov28/fastswap/sum/log."

# copy
logs[1]['with']    = "scripts/figgen/results/chunking_results_nov28/carm_chunking_prefetch_enabled/carm_copy/log."
logs[1]['without'] = "scripts/figgen/results/chunking_results_nov28/fastswap/copy/log."

# triad
logs[2]['with']    = "scripts/figgen/results/chunking_results_nov28/carm_chunking_prefetch_enabled/carm_triad/log."
logs[2]['without'] = "scripts/figgen/results/chunking_results_nov28/fastswap/triad/log."
...
for i, ax in enumerate(axs):
    ...
    if i == 1:
        ax.set_ylabel('speedup vs. Fastswap', fontsize=20)
