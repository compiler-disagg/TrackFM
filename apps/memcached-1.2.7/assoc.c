...
void assoc_init(void) {
    void * sp0 = malloc(hashsize(hashpower) * sizeof(void *));
    memset(sp0, 0, hashsize(hashpower) * sizeof(void *));
//primary_hashtable = calloc(hashsize(hashpower), sizeof(void *));
primary_hashtable = sp0;
...
static void assoc_expand(void) {
    ...
    void * sp0 = malloc(hashsize(hashpower + 1) * sizeof(void *));
    memset(sp0, 0, hashsize(hashpower + 1) * sizeof(void *));
