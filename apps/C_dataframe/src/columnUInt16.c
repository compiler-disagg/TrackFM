...
static int setSelInt8(uint16_t * data, int8_t * selection_column, int8_t  selection, size_t size, uint16_t * dst) {
    int j = 0;
    int i = 0;
    uint16_t dat;
    uint16_t select_val;
...
static int setSelInt32(uint16_t * data, int32_t * selection_column, int32_t  selection, size_t size, uint16_t * dst) {
    int j = 0;
    int i = 0;
    uint16_t dat;
    uint16_t select_val;
...
static const char*
AddDateTime(DataFrame_ColumnUInt16* self, long datetime)
{
   
    return NULL;
}
static uint16_t 
GetValue(DataFrame_ColumnUInt16* self, size_t index)
{
...
static bool iis_unique(uint16_t * seen_val, uint16_t new_val, size_t size) { 
...
static int setUnique(uint16_t * val, uint16_t * data, size_t size) {
...
static uint16_t*
GetUnique(DataFrame_ColumnUInt16* self)
{
     //__attribute__((annotate("local_malloc")))
    uint16_t * val = (uint16_t *) malloc(SELF->size * sizeof(uint16_t));
...
static uint16_t* 
GetBySelInt32(DataFrame_ColumnUInt16* self, int32_t * selection_column, int32_t  selection) {
...
static uint16_t* 
GetBySelInt8(DataFrame_ColumnUInt16* self, int8_t * selection_column, int8_t  selection) {
...
static size_t GetGE(uint16_t  selection, uint16_t * dst,  uint16_t * data, size_t size) {
    int i = 0;
    int j = 0;
...
static uint16_t* 
GetBySelGE(DataFrame_ColumnUInt16* self, uint16_t  selection) {
...
static void group_BY_col(uint16_t * data, int8_t * group_column, 
		uint16_t ** groupby, int64_t  * group_size, int8_t * groups, size_t size, size_t ngroups) { 
...
#if 1
static uint16_t** 
GetBySelInt8Group(DataFrame_ColumnUInt16* self, int8_t * group_column, int8_t  * groups, int8_t ngroups, uint16_t * copy_data) {

    uint16_t * data = copy_data;

    int i = 0;
//     __attribute__((annotate("local_malloc")))
    uint16_t ** groupby = (uint16_t **) malloc(ngroups * sizeof(uint16_t *));

   int64_t * group_size = (int64_t *) malloc(ngroups * sizeof(int64_t));

   for (i = 0; i < ngroups; i++) {
	groupby[i] = malloc(SELF->size * sizeof(uint16_t));
	group_size[i] = 0;
   }
...
static uint16_t* 
GetBySelString(DataFrame_ColumnUInt16* self, char ** selection, char * select_val) {

    //__attribute__((annotate("local_malloc")))
    uint16_t * val = (uint16_t *) malloc(SELF->col_size * sizeof(uint16_t));
...
static uint16_t* 
GetBySelStringUnique(DataFrame_ColumnUInt16* self, char ** selection_column, char * selection) {
...
static int setSelInt8Unique(uint16_t * val, uint16_t * data, int8_t * selection_column, int8_t selection, size_t size) {
...
static uint16_t* 
GetBySelInt8Unique(DataFrame_ColumnUInt16* self, int8_t * selection_column, int8_t selection) {
...
static uint16_t*
GetAll(DataFrame_ColumnUInt16* self)
{
    return SELF->data;
}

static void copy_col(uint16_t * dst, uint16_t * src, uint64_t size) {
	for (int i = 0; i < size; i++) {
		dst[i] = src[i]; 
	}
}
...
static uint16_t*
GetCopy(DataFrame_ColumnUInt16* self)
{
    int i = 0;
    uint16_t * copy = (uint16_t *) malloc(SELF->col_size * sizeof(uint16_t));
    uint16_t * data = SELF->data;
...
static int64_t * 
GetBySelInt8GroupSize(DataFrame_ColumnUInt16* self) {
...
static char*
SetName(DataFrame_ColumnUInt16* self, char* name)
{
    char* n;
...
static int
GetUniqueSize(DataFrame_ColumnUInt16* self)
{
    return SELF->unique_size;
}

static int
GetColSize(DataFrame_ColumnUInt16* self)
{
    return SELF->col_size;
}
static int
GetSelSize(DataFrame_ColumnUInt16* self)
{
...
DataFrame_ColumnUInt16* DataFrame_ColumnUInt16_New(int type)
{
