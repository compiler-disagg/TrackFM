...
static int setSelInt8(int16_t * data, int8_t * selection_column, int8_t  selection, size_t size, int16_t * dst) {
    int j = 0;
    int i = 0;
    int16_t dat;
    int16_t select_val;
...
static int setSelInt32(int16_t * data, int32_t * selection_column, int32_t  selection, size_t size, int16_t * dst) {
    int j = 0;
    int i = 0;
    int16_t dat;
    int16_t select_val;
...
static const char*
AddDateTime(DataFrame_ColumnInt16* self, long datetime)
{
   
    return NULL;
}
static int16_t 
GetValue(DataFrame_ColumnInt16* self, size_t index)
{
...
static const char*
AddColValues(DataFrame_ColumnInt16* self, int16_t * v, uint64_t size)
{
        SELF->data = v;
	      SELF->col_size = size;
	      SELF->size = size;
...
static bool iis_unique(int16_t * seen_val, int16_t new_val, size_t size) { 
...
static int setUnique(int16_t * val, int16_t * data, size_t size) {
...
static int16_t*
GetUnique(DataFrame_ColumnInt16* self)
{
     //__attribute__((annotate("local_malloc")))
    int16_t * val = (int16_t *) malloc(SELF->size * sizeof(int16_t));
...
static int16_t* 
GetBySelInt32(DataFrame_ColumnInt16* self, int32_t * selection_column, int32_t  selection) {

//     __attribute__((annotate("local_malloc")))
	int16_t * val = (int16_t *) malloc(SELF->size * sizeof(int16_t));
	int16_t * data = SELF->data;
...
static int16_t* 
GetBySelInt8(DataFrame_ColumnInt16* self, int8_t * selection_column, int8_t  selection) {
...
static size_t GetGE(int16_t  selection, int16_t * dst,  int16_t * data, size_t size) {
    int i = 0;
    int j = 0;
...
static int16_t* 
GetBySelGE(DataFrame_ColumnInt16* self, int16_t  selection) {
...
static void group_BY_col(int16_t * data, int8_t * group_column, 
		int16_t ** groupby, int64_t  * group_size, int8_t * groups, size_t size, size_t ngroups) { 
...
#if 1
static int16_t** 
GetBySelInt8Group(DataFrame_ColumnInt16* self, int8_t * group_column, int8_t  * groups, int8_t ngroups, int16_t * copy_data) {

    int16_t * data = copy_data;

    int i = 0;
//     __attribute__((annotate("local_malloc")))
    int16_t ** groupby = (int16_t **) malloc(ngroups * sizeof(int16_t *));

   int64_t * group_size = (int64_t *) malloc(ngroups * sizeof(int64_t));

   for (i = 0; i < ngroups; i++) {
	groupby[i] = malloc(SELF->size * sizeof(int16_t));
	group_size[i] = 0;
   }
...
static int16_t* 
GetBySelString(DataFrame_ColumnInt16* self, char ** selection, char * select_val) {

    //__attribute__((annotate("local_malloc")))
    int16_t * val = (int16_t *) malloc(SELF->col_size * sizeof(int16_t));
...
static int16_t* 
GetBySelStringUnique(DataFrame_ColumnInt16* self, char ** selection_column, char * selection) {
...
static int setSelInt8Unique(int16_t * val, int16_t * data, int8_t * selection_column, int8_t selection, size_t size) {
...
static int16_t* 
GetBySelInt8Unique(DataFrame_ColumnInt16* self, int8_t * selection_column, int8_t selection) {
...
static int16_t*
GetAll(DataFrame_ColumnInt16* self)
{
    return SELF->data;
}

static void copy_col(int16_t * dst, int16_t * src, uint64_t size) {
	for (int i = 0; i < size; i++) {
		dst[i] = src[i]; 
	}
}
...
static int16_t*
GetCopy(DataFrame_ColumnInt16* self)
{
    int i = 0;
    int16_t * copy = (int16_t *) malloc(SELF->col_size * sizeof(int16_t));
    int16_t * data = SELF->data;
...
static int64_t * 
GetBySelInt8GroupSize(DataFrame_ColumnInt16* self) {
...
static char*
SetName(DataFrame_ColumnInt16* self, char* name)
{
    char* n;
...
static bool
HasValue(DataFrame_ColumnInt16* self, size_t index)
{
    bool na = DataFrame_BitVector_Get(&SELF->na, index);
    return !na;
}
...
static int16_t *
Get(DataFrame_ColumnInt16* self, size_t index)
{
    return &SELF->data[index];
}

static uint8_t*
GetNAs(DataFrame_ColumnInt16* self)
{
    return SELF->na.data;
}

static int
GetUniqueSize(DataFrame_ColumnInt16* self)
{
    return SELF->unique_size;
}

static int
GetColSize(DataFrame_ColumnInt16* self)
{
    return SELF->col_size;
}
static int
GetSelSize(DataFrame_ColumnInt16* self)
{
...
DataFrame_ColumnInt16* DataFrame_ColumnInt16_New(int type)
{
